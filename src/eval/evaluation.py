...
EVAL_CASES = [
    EvalCase(id="case_001", question="what are the types of rigs?", category="general"),
    EvalCase(id="case_002", question="Tell me about llm agents", category="summary"),
    EvalCase(id="case_003", question="what is use of reamer?", category="summary"),
    EvalCase(id="case_004", question="when should we drill?", category="general"),
    EvalCase(id="case_005", question="Talk about role of drilling liquids in hole stabilization", category="drilling fluid"),
    EvalCase(id="case_006", question="give a summary on drilling fluids", category="drilling fluid"),
    ...
    EvalCase(id="case_009", question="explain about drilling fluid additives", category="drilling fluid"),
    EvalCase(id="case_010", question="challenges with llm agents", category="general"),
    EvalCase(id="case_011", question="explain about logging in drills", category="summary"),
    EvalCase(id="case_012", question="what are the common drilling problems?", category="general"),
]
